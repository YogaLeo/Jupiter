...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "ni45c1xAWZCIYoQmlANCMs19Tdm9gIGm";
	...
	public List<Event> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s&size=%s", API_KEY, geoHash, keyword,
	...
	private List<Event> getItemList(JSONArray events) throws JSONException {
	...
	public void queryAPI(double lat, double lon) {
		List<Event> events = search(lat, lon, null);
...
//{"next":{"href":"/discovery/v2/events.json?latlong=29.682684%2C-95.29541&radius=50&page=1&size=20"},
//	"last":{"href":"/discovery/v2/events.json?latlong=29.682684%2C-95.29541&radius=50&page=37&size=20"},
//	"self":{"href":"/discovery/v2/events.json?latlong=29.682684%2C-95.29541&radius=50"},
//	"first":{"href":"/discovery/v2/events.json?latlong=29.682684%2C-95.29541&radius=50&page=0&size=20"}}
